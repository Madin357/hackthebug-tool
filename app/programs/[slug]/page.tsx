      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  ...
                  <Badge variant="outline" className={cn(statusColors[program.status])}>
                    {program.status.charAt(0).toUpperCase() + program.status.slice(1)}
                  </Badge>
                </div>
                <p className="text-muted-foreground mb-3">{program.organization}</p>
                <div className="flex flex-wrap gap-2">
                  <Badge variant="secondary">{typeLabels[program.type]}</Badge>
            ...
            <div className="flex flex-col sm:flex-row lg:flex-col gap-4">
              <div className="grid grid-cols-3 gap-4 sm:gap-6">
                ...
                <div className="text-center sm:text-left">
                  ...
                  <p className="font-semibold text-foreground">{program.assetsCount}</p>
                </div>
                <div className="text-center sm:text-left">
                  <div className="flex items-center justify-center sm:justify-start gap-1 text-muted-foreground mb-1">
              ...
              <div className="flex gap-2">
                <Button onClick={() => setIsReportModalOpen(true)} className="flex-1 sm:flex-none">
        ...
        <Tabs defaultValue="overview" className="space-y-6">
            ...
            >
              ...
              <div className="lg:col-span-2 space-y-6">
                <div className="rounded-xl border border-border bg-card p-6">
                  <h2 className="text-lg font-semibold text-foreground mb-4">Program Summary</h2>
                ...
                <div className="rounded-xl border border-border bg-card p-6">
                  <h2 className="text-lg font-semibold text-foreground mb-4">Response Times</h2>
                  <div className="grid sm:grid-cols-3 gap-4">
                    ...
                    <div className="p-4 rounded-lg bg-secondary/50">
                      <p className="text-xs text-muted-foreground mb-1">Triage</p>
                      <p className="text-lg font-semibold text-foreground">
              ...
              <div className="space-y-6">
                <div className="rounded-xl border border-border bg-card p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-muted-foreground">In-Scope Assets</span>
                      <span className="font-medium text-foreground">{program.inScope.length}</span>
                    </div>
                    <div className="flex justify-between">
                ...
                <div className="rounded-xl border border-primary/30 bg-primary/5 p-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="text-sm font-semibold text-foreground mb-2">Safe Harbor</h3>
                      <p className="text-xs text-muted-foreground">
                        This program provides safe harbor for security researchers who follow the
                        program rules and test responsibly.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            >
              ...
              <div className="rounded-xl border border-border bg-card p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-lg font-semibold text-foreground">In Scope</h2>
                </div>
                <div className="space-y-3">
                  {program.inScope.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div>
                          <p className="font-medium text-foreground text-sm">{item.target}</p>
                          {item.description && (
              ...
              <div className="rounded-xl border border-border bg-card p-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-lg font-semibold text-foreground">Out of Scope</h2>
                </div>
                  ...
                  {program.rewards.map((tier) => (
                    <TableRow key={tier.severity}>
                      ...
                      <TableCell className="font-medium">
                        ${tier.minReward.toLocaleString()} - ${tier.maxReward.toLocaleString()}
                      </TableCell>
                      <TableCell className="text-muted-foreground">{tier.sla}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
          ...
          <TabsContent value="rules" className="space-y-6">
            ...
            >
              <div className="rounded-xl border border-border bg-card p-6">
                <h2 className="text-lg font-semibold text-foreground mb-4">Program Rules</h2>
              ...
              <div className="rounded-xl border border-warning/30 bg-warning/5 p-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Safe Harbor Statement</h3>
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      We will not pursue legal action against researchers who discover and report
                      vulnerabilities responsibly, following these program rules. We consider
                      security research conducted under this policy to be authorized, lawful, and
                      helpful to the overall security of the internet.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <TabsContent value="updates">
            ...
            >
              <h2 className="text-lg font-semibold text-foreground mb-6">Program Updates</h2>
                  ...
                  {program.updates.map((update) => (
                    <div key={update.id} className="relative pl-8">
                      ...
                      <div className="flex flex-wrap items-center gap-2 mb-1">
                        <Badge variant="outline" className={updateTypeColors[update.type]}>
              ...
              {program.hallOfFame.length > 0 ? (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          {entry.reportsAccepted} reports accepted
                        </p>
                      </div>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-muted-foreground">
                    No researchers yet. Be the first to find a vulnerability!
                  </p>
                </div>
              )}
            </motion.div>
        ...
        {/* Related Programs */}
        <div className="mt-12">
          <h2 className="text-xl font-semibold text-foreground mb-6">Similar Programs</h2>
          <div className="grid md:grid-cols-3 gap-6">
            {programs
              .filter((p) => p.id !== program.id && p.industry === program.industry)
              .slice(0, 3)
              .map((relatedProgram) => (
                <Link
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium text-foreground">{relatedProgram.name}</p>
                      <p className="text-xs text-muted-foreground">{relatedProgram.organization}</p>
                    </div>
                  </div>
                </Link>
              ))}
